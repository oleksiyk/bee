...
Redis.prototype.job_put = function (job) {
    ...
    return this._callScript('job/put', JSON.stringify({
            jid: job.jid,
            queue: job.queue,
            options: job.options,
            tags: job.tags,
...
Redis.prototype.job_pop = function (bee, max) {
    ...
    return this._callScript('job/pop', JSON.stringify({
        queue: bee.queue,
        worker: bee.id,
        max: max
    }));
...
Redis.prototype.job_done = function (job, bee, result) {
    ...
    return this._callScript('job/done', JSON.stringify({
            queue: job.queue,
            jid: job.jid,
            worker: bee.id,
            result: result,
...
Redis.prototype.job_failed = function (job, bee, err) {
    ...
    return this._callScript('job/failed', JSON.stringify({
            queue: job.queue,
            worker: bee.id,
            jid: job.jid,
            exception: err,
...
Redis.prototype.job_load = function (jid) {
    ...
    return this._callScript('job/load', JSON.stringify({
            jid: jid
        }))
...
Redis.prototype.job_hash = function (job, bee) {
    ...
    return this._callScript('job/hash', JSON.stringify({
            queue: job.queue,
            jid: job.jid,
            hash: job.hash,
            worker: bee.id
...
Redis.prototype.job_set_tags = function (job, tags) {
    ...
    return this._callScript('job/setTags', JSON.stringify({
        jid: job.jid,
        tags: tags
    }));
...
Redis.prototype.job_cancel = function (jid) {
    ...
    return this._callScript('job/cancel', JSON.stringify({
            jid: jid
        })).then(function (result) {
        if (!result) {
            throw new Error('Not found')
...
Redis.prototype.bee_heartbeat = function (bee) {
    ...
    return this._callScript('bee/heartbeat', JSON.stringify({
        queue: bee.queue,
        worker: bee.id
    }))
}
